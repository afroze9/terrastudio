...
const highContrast: ThemePalette = {
  ...
  dark: {
    ...
    'color-accent': '#1e90ff',
    'color-accent-hover': '#1a7de0',
    'color-accent-text': '#ffffff',
    'color-shadow': 'rgba(255, 255, 255, 0.15)',
    'scrollbar-thumb': 'rgba(30, 144, 255, 0.3)',
    'scrollbar-thumb-hover': 'rgba(30, 144, 255, 0.5)',
  },
  light: {
    'color-bg': '#ffffff',
...
const monokai: ThemePalette = {
  ...
  dark: {
    ...
    'color-accent-text': '#ffffff',
    'color-shadow': 'rgba(0, 0, 0, 0.5)',
    'scrollbar-thumb': 'rgba(253, 64, 128, 0.15)',
    'scrollbar-thumb-hover': 'rgba(253, 64, 128, 0.3)',
  },
  light: {
    'color-bg': '#fafaf8',
...
const colorblindDeuteranopia: ThemePalette = {
  ...
  dark: {
    ...
    'color-text-muted': '#8b949e',
    'color-accent': '#0072b2',
    'color-accent-hover': '#005f94',
    'color-accent-text': '#ffffff',
    'color-shadow': 'rgba(0, 0, 0, 0.4)',
    'scrollbar-thumb': 'rgba(0, 114, 178, 0.15)',
    'scrollbar-thumb-hover': 'rgba(0, 114, 178, 0.3)',
  },
  light: {
    'color-bg': '#ffffff',
    'color-surface': '#f6f8fa',
    ...
    'color-accent-text': '#ffffff',
    'color-shadow': 'rgba(0, 0, 0, 0.08)',
    'scrollbar-thumb': 'rgba(0, 114, 178, 0.2)',
    'scrollbar-thumb-hover': 'rgba(0, 114, 178, 0.35)',
  },
};
...
const colorblindProtanopia: ThemePalette = {
  ...
  dark: {
    ...
    'color-text-muted': '#8b949e',
    'color-accent': '#56b4e9',
    'color-accent-hover': '#3a9fd4',
    'color-accent-text': '#000000',
    'color-shadow': 'rgba(0, 0, 0, 0.4)',
    'scrollbar-thumb': 'rgba(86, 180, 233, 0.15)',
    'scrollbar-thumb-hover': 'rgba(86, 180, 233, 0.3)',
  },
  light: {
    'color-bg': '#ffffff',
    'color-surface': '#f6f8fa',
...
const colorblindTritanopia: ThemePalette = {
  ...
  dark: {
    ...
    'color-text-muted': '#8b949e',
    'color-accent': '#d55e00',
    'color-accent-hover': '#b84f00',
    'color-accent-text': '#ffffff',
    'color-shadow': 'rgba(0, 0, 0, 0.4)',
    'scrollbar-thumb': 'rgba(213, 94, 0, 0.15)',
    'scrollbar-thumb-hover': 'rgba(213, 94, 0, 0.3)',
  },
  light: {
    'color-bg': '#ffffff',
    'color-surface': '#f6f8fa',
    ...
    'color-accent-text': '#ffffff',
    'color-shadow': 'rgba(0, 0, 0, 0.08)',
    'scrollbar-thumb': 'rgba(213, 94, 0, 0.2)',
    'scrollbar-thumb-hover': 'rgba(213, 94, 0, 0.35)',
  },
};
...
export const builtinPalettes: Map<BuiltinPaletteId, ThemePalette> = new Map([
  ...
  ['monokai', monokai],
  ['github', github],
  ['colorblind-deuteranopia', colorblindDeuteranopia],
  ['colorblind-protanopia', colorblindProtanopia],
  ['colorblind-tritanopia', colorblindTritanopia],
]);
