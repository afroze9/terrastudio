...
export const containerAppSchema: ResourceSchema = {
  ...
  properties: [
    ...
    { key: 'environment_variables', label: 'Environment Variables', type: 'key-value-map', required: false, group: 'Container', order: 9 },
    { key: 'min_replicas', label: 'Min Replicas', type: 'number', required: false, defaultValue: 0, group: 'Scaling', order: 10, validation: { min: 0, max: 300 } },
    { key: 'max_replicas', label: 'Max Replicas', type: 'number', required: false, defaultValue: 10, group: 'Scaling', order: 11, validation: { min: 1, max: 300 } },
    {
      key: 'secrets',
      label: 'Secrets',
      type: 'array',
      ...
      itemSchema: {
        ...
        nestedSchema: [
          ...
          { key: 'value', label: 'Value', type: 'string', required: true, sensitive: true },
        ],
      },
    },
    { key: 'identity_enabled', label: 'Enable Identity', type: 'boolean', required: false, defaultValue: false, group: 'Identity', order: 13 },
    {
      key: 'identity_type',
      label: 'Identity Type',
      type: 'select',
