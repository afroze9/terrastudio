...
export const vmSchema: ResourceSchema = {
  ...
  properties: [
    ...
    },
    {
      ...
      group: 'Licensing',
      order: 17,
      description: 'Azure Hybrid Benefit for BYOS Linux',
      options: [
        { label: 'None', value: '' },
        { label: 'Azure Hybrid Benefit (RHEL)', value: 'RHEL_BYOS' },
        { label: 'Azure Hybrid Benefit (SLES)', value: 'SLES_BYOS' },
      ],
    },
  ],
