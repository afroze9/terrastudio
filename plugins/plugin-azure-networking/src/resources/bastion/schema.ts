...
export const bastionSchema: ResourceSchema = {
  ...
  category: 'networking',
  description: 'Azure Bastion — secure browser-based RDP/SSH without exposing VMs to the internet',
  ...
  properties: [
    ...
    },
    {
      ...
      order: 13,
      defaultValue: false,
      description: 'Enable native client connections via IP',
    },
    {
      ...
      visibleWhen: { field: 'sku', operator: 'truthy' as const },
    },
    {
      key: 'scale_units',
      label: 'Scale Units',
