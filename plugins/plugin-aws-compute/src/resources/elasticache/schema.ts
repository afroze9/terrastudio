...
export const elasticacheSchema: ResourceSchema = {
  ...
  properties: [
    ...
    },
    {
      ...
      type: 'string',
      required: false,
      description: 'Name of the ElastiCache subnet group for VPC placement',
      group: 'Networking',
      order: 7,
    },
    {
    ...
    },
    {
      ...
      type: 'string',
      required: false,
      description: 'Name of the parameter group for custom config',
      group: 'Configuration',
      order: 9,
    },
    {
      ...
      type: 'select',
      required: false,
      defaultValue: 'single-az',
      options: [
        { label: 'Single AZ', value: 'single-az' },
        { label: 'Cross AZ', value: 'cross-az' },
      ],
      description: 'Only applies to Memcached with 2+ nodes',
      group: 'High Availability',
      order: 10,
    },
    {
      key: 'notification_topic_arn',
      label: 'SNS Topic ARN',
      type: 'string',
      required: false,
      description: 'ARN of SNS topic for cache event notifications',
      group: 'Notifications',
      order: 11,
    },
  ],
