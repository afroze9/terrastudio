...
export const ec2InstanceSchema: ResourceSchema = {
  ...
  properties: [
    ...
    },
    {
      ...
      required: false,
      defaultValue: false,
      description: 'Prevent accidental termination via the API',
      group: 'Security',
      order: 9,
    },
    {
      key: 'metadata_http_tokens',
      label: 'IMDSv2 Token Requirement',
      type: 'select',
      required: false,
      defaultValue: 'required',
      description: "Set to 'required' to enforce IMDSv2",
      group: 'Security',
      order: 10,
      options: [
        { label: 'Required (recommended)', value: 'required' },
        { label: 'Optional', value: 'optional' },
      ],
    },
    {
      key: 'metadata_http_endpoint',
    ...
    },
    {
      ...
      type: 'string',
      required: false,
      description: 'Startup script (base64-encoded automatically)',
